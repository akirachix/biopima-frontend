...
export default function AddUser() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const newErrors = { name: "", email: "", phone_number: "", username: "" };
    let hasError = false;
    ...
    <ConsultantLayout>
      <div className="flex w-full bg-white">
        <div className="flex-1 p-6">
          ...
          <div className="bg-[#255723] rounded-2xl p-38">
            {successMessage && (
            ...
            >
              <div className="w-[80%]">
                ...
                <input
                  ...
                  className="w-full p-4 rounded-md bg-white text-black outline-none"
                />
                {errors.name && (
              ...
              <div className="col-span-2 flex justify-end mt-4 mr-[10%]">
                <button
                  type="submit"
