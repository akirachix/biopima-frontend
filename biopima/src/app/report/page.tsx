...
import { Chart as ChartJS, CategoryScale, LinearScale, BarElement, Title, Tooltip, ChartOptions, ChartData } from 'chart.js';
      ...
      <div className="flex h-screen max-h-screen overflow-hidden">
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-gray-50 min-w-0 ml-56">
          <div className="text-center max-w-md">
            <div className="text-red-600 text-xl mb-2" aria-label="error-icon"></div>
