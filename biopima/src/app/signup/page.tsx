      ...
      <div className="flex bg-white rounded-xl shadow-lg overflow-hidden w-[1600px] h-[800px] ">
        ...
        <div className="w-1/2 p-10 mt-[-17] bg-white">
          <form onSubmit={handleSubmit} className="space-y-4 pt-5 pr-10">
            <div>
              <label className="block text-green-900 text-[20px] font-semibold mb-1">Name</label>
              <input
                type="text"
                name="name"
                placeholder="Name"
            ...
            <div>
              <label className="block text-green-900 text-[20px] font-semibold mb-1">Company Name</label>
              <input
                type="text"
                name="companyName"
            ...
            <div>
              <label className="block text-green-900 text-[20px] font-semibold mb-1">Phone Number</label>
              <input
                type="text"
                name="phone"
            ...
            <div className="relative">
              <label className="block text-green-900 text-[20px] font-semibold mb-1">Create Password</label>
              <input
            ...
            <div className="relative">
              <label className="block text-green-900 text-[20px] font-semibold mb-1">Confirm Password</label>
              <input
          ...
          {formError && <p className="text-red-600 mt-[-120] ">{formError}</p>}
        </div>
      </div>
    </div>
  );
